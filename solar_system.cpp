...
CelestialBody rocket = CelestialBody("Artemis", to_solarmass(payload), .25, '^', Vector3::zero, Vector3::zero, true);
...
int main()
{
    ...
    std::ofstream rocket_data_file ("rocket_data.csv");
