    ...
    namespace Dynamics
    {
        ...
        */
        ...
        /* @brief Simple as it gets - Calculate gravitational force on body due to affector (with user-provided G).
            ...
            * * @param body Affector body
            * * @return Force vector from affected body towards affector
            * * @param ugc Value of Universal Gravitational constant
        */
        ...
        * * @param target Pointer to target body whose peturbations we are calculating
        * * @param pgb Pointer to primary gravitational body
       ...
       /* @brief Calculate eccentricity of a body's orbit about another.
        * * @param orbiting_r Position vector of orbiting body
        * * @param orbiting_v Velocity vector of orbiting body
        * * @param G Universal Gravitational Constant
        * * @param M Mass of PGB
        * * @return Eccentricity of body's orbit about M
        */ 
        double calculate_orbit_eccentricity(Vector3 orbiting_r, Vector3 orbiting_v, double G, double M);

        /* @brief Calculate Specific Mechanical Energy of a body's orbit about another.
        * * @param orbiting_r Position vector of orbiting body
        * * @param orbiting_v Velocity vector of orbiting body
        * * @param G Universal Gravitational Constant
        * * @param M Mass of PGB
        * * @return Specific mechanical energy of body's orbit about M
        */ 
        double calculate_specific_mechanical_energy(Vector3 orbiting_r, Vector3 orbiting_v, double G, double M);

        /* @brief Calculate length of semi-major axis of a body's orbit about another.
        * * @param orbiting_r Position vector of orbiting body
        * * @param orbiting_v Velocity vector of orbiting body
        * * @param G Universal Gravitational Constant
        * * @param M Mass of PGB
        * * @return Length of semi-major axis of body's orbit about M
        */ 
        double calculate_orbit_semi_major(Vector3 orbiting_r, Vector3 orbiting_v, double G, double M);

        /* @brief Get pointer to priamry gravitational body in a group of bodies.
        * * @param bodies Collection of bodies to get PGB from
        * * @return Pointer to PGB of system
        */ 
